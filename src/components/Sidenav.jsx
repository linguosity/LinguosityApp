...
const Toolbar = ({ openForm, pdfDocument }) => {
  ...
  return (
    ...
    data-step="2" onClick={() => setIsRightColumnVisible(!isRightColumnVisible)}>
...
export default function Sidenav({ openForm, pdfDocument, isRightColumnVisible, setIsRightColumnVisible}) {
  ...
  return (
    ...
    <div className="sidenav-wrapper">
...

      {
        size === "small" ?
          <Box>
            <DropButton label={<IconMenu />} dropContent={<Toolbar pdfDocument={pdfDocument} openForm={openForm} setIsRightColumnVisible={setIsRightColumnVisible}/>} />
          </Box>
          :
          <div className="footer-content">
            <Toolbar pdfDocument={pdfDocument} openForm={openForm} setIsRightColumnVisible={setIsRightColumnVisible}/>
          </div>
      }
    </div >
  );
